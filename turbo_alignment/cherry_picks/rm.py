...
from turbo_alignment.generators.multihead import MultiHeadPairGenerator
...
class MultiHeadCherryPickCallback(CherryPickCallbackBase[PairPreferenceDataset]):
    def __init__(
        self,
        cherry_pick_settings: RMCherryPickSettings,
        datasets: Iterable[PairPreferenceDataset],
    ...
    def _get_dataset_metrics(
        ...
        **kwargs,
        ...
        generator = MultiHeadPairGenerator(
            model=model,
            tokenizer=tokenizer,
            accelerator=accelerator,
        )
