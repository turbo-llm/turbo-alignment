...
from transformers.models.qwen3.modeling_qwen3 import (
    Qwen3DecoderLayer as Qwen3DecoderLayerBase,
)
from transformers.models.qwen3.modeling_qwen3 import (
    Qwen3ForCausalLM,
    Qwen3MLP,
...
class Qwen3ModelWithMPU(Qwen3PreTrainedModel, Qwen3Model):
    """
...
class Qwen3ForCausalLMWithMPU(GenerationMixinWithSeqP, PreTrainedModelWithMPU, Qwen3ForCausalLM):
    def __init__(self, config):
        super().__init__(config)
        self.model = Qwen3ModelWithMPU(config)
        self.vocab_size = config.vocab_size
    ...
    def forward(
        ...
        **kwargs: Unpack[KwargsForCausalLM],
        ...
        if self.training and self.config._attn_implementation != "eager":
            logger.warning_once(
                "It is strongly recommended to train Qwen2 models with the `eager` attention implementation "
...
class Qwen3ForSequenceClassificationWithMPU(Qwen3PreTrainedModel):
    def __init__(self, config):
        super().__init__(config)
