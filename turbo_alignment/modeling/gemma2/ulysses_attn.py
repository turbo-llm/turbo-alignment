...
from turbo_alignment.modeling.parallel_states import get_sequence_parallel_group
...
class Gemma2FlashAttention2Ulysses(Gemma2Attention):
    ...
    def forward(
        ...
        _forward = DistributedAttention(_flash_attention_forward, get_sequence_parallel_group())
