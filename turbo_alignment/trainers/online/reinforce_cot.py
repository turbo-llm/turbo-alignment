...
class REINFORCECoTTrainer(MultiGPUCherryPicksTrainer):
    def __init__(
        self,
        vllm_engines: list,
    ...
    def get_batch_loss_metrics(
        ...
        loss = - baselined_reward * (logprobs * cot_loss_mask).sum(-1) - ((logprobs * answer_loss_mask).sum(-1))
    ...
    def get_logprobs(
        ...
        if not log_softmax:
            all_logprob = F.softmax(logits, dim=-1)
