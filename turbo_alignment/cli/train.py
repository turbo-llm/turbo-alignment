...
def train_sft_entrypoint(
    ...
    experiment_settings = pipeline_settings.SftTrainExperimentSettings.parse_file(
        experiment_settings_path
    )
...
def train_dpo_entrypoint(
    ...
    experiment_settings = pipeline_settings.DPOTrainExperimentSettings.parse_file(
        experiment_settings_path
    )
...
def train_kto_entrypoint(
    ...
    experiment_settings = pipeline_settings.KTOTrainExperimentSettings.parse_file(
        experiment_settings_path
    )
...
def train_ddpo_entrypoint(
    ...
    experiment_settings = pipeline_settings.DDPOTrainExperimentSettings.parse_file(
        experiment_settings_path
    )
...
def train_rm_entrypoint(
    ...
    experiment_settings = pipeline_settings.RMTrainExperimentSettings.parse_file(
        experiment_settings_path
    )
...
def classification_training(
    ...
    experiment_settings = (
        pipeline_settings.ClassificationTrainExperimentSettings.parse_file(
            experiment_settings_path
        )
    )
...
def multimodal_training(
    ...
    experiment_settings = (
        pipeline_settings.MultimodalTrainExperimentSettings.parse_file(
            experiment_settings_path
        )
    )
...
def rag_training(
    ...
    experiment_settings = pipeline_settings.RAGTrainExperimentSettings.parse_file(
        experiment_settings_path
    )
